    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    nft_address = table.Column<string>(type: "character varying(42)", maxLength: 42, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    commenter_address = table.Column<string>(type: "character varying(42)", maxLength: 42, nullable: false),
                    post_nft_address = table.Column<string>(type: "character varying(42)", maxLength: 42, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    admin_address = table.Column<string>(type: "character varying(42)", maxLength: 42, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    liker_address = table.Column<string>(type: "character varying(42)", maxLength: 42, nullable: false),
                    post_nft_address = table.Column<string>(type: "character varying(42)", maxLength: 42, nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sender_address = table.Column<string>(type: "character varying(42)", maxLength: 42, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sender_address = table.Column<string>(type: "character varying(42)", maxLength: 42, nullable: false),
                    chat_id = table.Column<long>(type: "bigint", nullable: false),
